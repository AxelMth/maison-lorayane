        ...
        {open ? (
          <div id="mobile-menu" className="md:hidden pb-3">
            ...
            <div className="mt-3 px-3 flex justify-end space-x-4">
              <Link href="https://www.facebook.com/p/Maison-LOrayane-100088821732375/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-2 hover:opacity-90" onClick={() => setOpen(false)}>
                <Facebook className="h-5 w-5" />
              </Link>
              <Link href="https://www.instagram.com/maison_lorayane/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-2 hover:opacity-90" onClick={() => setOpen(false)}>
                <Instagram className="h-5 w-5" />
              </Link>
            </div>
          </div>
